      ...
      <div className='bg-black text-[#0000ff0c]'>
        <div className='max-w-[1100px] mx-auto px-6'>
          ...
          <div className="relative px-9 min-h-[250px] lg:min-h-[400px] flex items-center justify-center">
            ...
            <div>
              <div className='bg-black w-[40px] h-[180px] flex justify-center items-center transform -translate-y-1/2 absolute top-1/2 left-0 z-20 '>
              ...
              <div className='bg-black w-[40px] h-[180px] flex justify-center items-center transform -translate-y-1/2 absolute top-1/2 -right-5 z-20 '>
          ...
          <div>
            ...
            <div className='grid gap-3 md:grid-cols-2 lg:grid-cols-4'>
              <div className='text-white relative p-4 pb-24 lg:min-h-[360px] rounded-2xl  bg-gradient-to-br from-[#192145] to-[#200e19]'>
                <h1 className='text-xl font-semibold py-3 lg:text-2xl'>Enjoy on your TV</h1>
                <h3 className='text-[#ffffffb3] leading-6 lg:text-xl'>Watch on Smart TVs, Playstation, Xbox, Chromecast, Apple TV, Blu-ray players, and more.</h3>
              ...
              <div className='text-white relative p-4 pb-24 rounded-2xl  bg-gradient-to-br from-[#192145] to-[#200e19]'>
                <h1 className='text-xl font-semibold py-3'>Download your shows to watch offline</h1>
                <h3 className='text-[#ffffffb3] leading-6'>Save your favorites easily and always have something to watch.</h3>
              ...
              <div className='text-white relative p-4 pb-24 rounded-2xl  bg-gradient-to-br from-[#192145] to-[#200e19]'>
                ...
                <h3 className='text-[#ffffffb3] leading-6'>Stream unlimited movies and TV shows on your phone, tablet, laptop, and TV.</h3>
              ...
              <div className='text-white relative p-4 pb-24 rounded-2xl  bg-gradient-to-br from-[#192145] to-[#200e19]'>
                ...
                <h3 className='text-[#ffffffb3] leading-6'>Send kids on adventures with their favorite characters in a space made just for them — free with your membership.</h3>
            ...
            <div className='grid gap-2' id="accordion-collapse" data-accordion="collapse">
              <div>
                <h2 id="accordion-collapse-heading-1">
                  ...
                  >
                    <span className="text-xl">What is Netflix?</span>
                    <BsPlusLg className={`${openIndex === 0 ? 'rotate-45' : ''} text-3xl`} />
                  </button>
                </h2>
                <div
                  id="accordion-collapse-body-1"
                  className={`${openIndex === 0 ? 'h-full' : 'h-0'}`}
                  aria-labelledby="accordion-collapse-heading-1"
                >
                  <div className={`${openIndex === 0 ? 'h-full' : 'h-0 text-transparent'} p-5 bg-[#2d2d2d] border-t-[1px] border-black text-white`} >
              ...
              <div>
                <h2 id="accordion-collapse-heading-1">
                  ...
                  >
                    <span className="text-xl">How much does Netflix cost?</span>
              ...
              <div>
                <h2 id="accordion-collapse-heading-1">
                  ...
                  >
                    <span className='text-xl'>Where can I watch?</span>
              ...
              <div>
                <h2 id="accordion-collapse-heading-1">
                  ...
                  >
                    <span className='text-xl'>How do I cancel?</span>
              ...
              <div>
                <h2 id="accordion-collapse-heading-1">
                  ...
                  >
                    <span className='text-xl'>What can I watch on Netflix?</span>
              ...
              <div>
                <h2 id="accordion-collapse-heading-1">
                  ...
                  >
                    <span className='text-xl'>is Netflix good for kids?</span>
              ...
              <div>
                <h2 id="accordion-collapse-heading-1">
                  ...
                  >
                    <span className='text-xl'>Why am I seeing this language?</span>
            ...
            <div className='pt-8'>
              ...
              <div className='flex flex-col sm:items-center  min-w-full sm:flex-row sm:justify-center sm:gap-4 lg:max-w-[650px] lg:mx-auto'>
                <div className="relative w-[70%] my-2">
                  <input type="text" placeholder="Email address"
                    className="peer h-[55px] pl-3 rounded-[.3rem] bg-[#191919b2] text-white outline-none border-[#dddddd4c] border-[1px] w-full 
                        placeholder:text-transparent  focus:pt-6 focus:pb-2"/>
                  <label
                    className="absolute top-1 left-0 p-3 h-full text-white text-md truncate pointer-events-none transition ease-in-out duration-100 
                        origin-[0_0] peer-focus:scale-90 peer-focus:translate-x-0.5 peer-focus:-translate-y-1.5 peer-focus:text-gray-400
                        peer-[:not(:placeholder-shown)]:scale-90text-[#dddddd4c]">Email address</label>
                </div>
                <button className='bg-[#ff0f0f] rounded-[.3rem] w-[30%] h-[55px] lg:w-[220px] lg:text-xl lg:font-semibold my-2 text-white hover:bg-[#c11119] transition-all duration-300 flex justify-center items-center'>Get Started <GoChevronRight className='text-xl md:ml-4 md:text-3xl' /></button>
              </div>
            </div>
