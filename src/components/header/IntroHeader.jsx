...
function Header() {
    return (
        <header>
            <nav className='max-w-[1150px] mx-auto pt-6 md:pt-2 px-6 flex flex-wrap gap-4  justify-between items-center'>
                ...
                <div className='w-[130px] sm:w-[240px] flex justify-between'>
                    ...
                    <Link to={"/login"}>
                        <button className='bg-white w-[80px] font-semibold h-[32px] rounded-full hover:bg-[#bbb] transition-all duration-300'>Sign In</button>
                    </Link>
                </div>
            </nav>
        </header >
