...
function IntroHeader() {
    ...
    return (
        <header>
            <nav className='w-[96%] xl:max-w-[1400px] mx-auto pt-6 md:pt-2 px-6 flex gap-4  justify-between items-center'>
                ...
                <div className='w-[130px] sm:w-[240px] flex justify-between gap-3'>
