                ...
                <div className={`fixed w-full bottom-0 z-30 h-[110px] px-[18px] flex flex-col justify-between `}>
                    ...
                    <div className='h-[110px] flex justify-between items-center '>
                        <div className='flex gap-[27px]'>
                            <button onClick={togglePlayPause} className='text-5xl hover:scale-[1.15] text-white'>
                                {isPlaying ? <MdOutlinePause /> : <IoMdPlay />}
                            </button>
                                        ...
                                        <div className="flex justify-between w-full h-[1px] bg-gray-200 ">
                                            <div className='flex flex-col items-start'>
                                                <div className='max-w-[min-content]'>
                                                    ...
                                                    <label for="1" className="block cursor-pointer select-none rounded-full w-[20px] h-[20px] bg-[grey] text-center mt-[-9px] peer-checked:bg-blue-500"></label>
                                                </div>
                                                <h3 className='mt-[10px] text-[18px]'>0.5x</h3>
                                            </div>
                                            <div className='flex flex-col items-center'>
                                                <div className='max-w-[min-content] text-end'>
                                                    <input type="radio" name="option" id="2" value="1" className="peer hidden" />
                                                    <label for="2" className="block cursor-pointer select-none rounded-full w-[20px] h-[20px] bg-[grey] text-center mt-[-9px] peer-checked:bg-blue-500"></label>
                                                </div>
                                                <h3 className='mt-[10px] mr-[-10px]  text-[18px]'>0.75x</h3>
                                            </div>
                                            <div className='flex flex-col items-center'>
                                                <div className='max-w-[min-content]'>
                                                    <input type="radio" name="option" id="3" value="1" className="peer hidden" />
                                                    <label for="3" className="block cursor-pointer select-none rounded-full w-[20px] h-[20px] bg-[grey] text-center mt-[-9px] peer-checked:bg-blue-500"></label>
                                                </div>
                                                <h3 className='mt-[10px] text-[18px]'>1x</h3>
                                            </div>
                                            <div className='flex flex-col items-center'>
                                                <div className='max-w-[min-content]'>
                                                    <input type="radio" name="option" id="4" value="1" className="peer hidden" />
                                                    <label for="4" className="block cursor-pointer select-none rounded-full w-[20px] h-[20px] bg-[grey] text-center mt-[-9px] peer-checked:bg-blue-500"></label>
                                                </div>
                                                <h3 className='mt-[10px] text-[18px]'>1.25x</h3>
                                            </div>
                                            <div className='flex flex-col items-end'>
                                                <div className='max-w-[min-content] text-end'>
                                                    <input type="radio" name="option" id="5" value="1" className="peer hidden" />
                                                    <label for="5" className="block cursor-pointer select-none rounded-full w-[20px] h-[20px] bg-[grey] text-center mt-[-9px] peer-checked:bg-blue-500"></label>
                                                </div>
